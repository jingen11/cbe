    ...
    <div className='drawer'>
      <div className='drawer-icons'>
        <IconButton onClick={toHome}>
          <svg xmlns="http://www.w3.org/2000/svg" className='svg-icon' aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><rect x="0" y="0" width="24" height="24" fill="none" stroke="none" />
      ...
      <div className='drawer-icons'>
        <IconButton onClick={toWorker}>
          <svg xmlns="http://www.w3.org/2000/svg" className='svg-icon' aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32"><rect x="0" y="0" width="32" height="32" fill="none" stroke="none" />
      ...
      <div className='drawer-icons'>
        <IconButton onClick={toVehicle}>
          <svg xmlns="http://www.w3.org/2000/svg" className='svg-icon' aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
